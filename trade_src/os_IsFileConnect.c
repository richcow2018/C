...
/*----------------------------------------------------------------------------------------------*/
/* ＜呼出形式＞ 																				*/
/*		#include	<os_IsFileConnect.h>														*/
/*																								*/
/*	   	long	os_IsFileConnect( long fildes )													*/
/*																								*/
/* ＜仮引数＞																					*/
/*		long		fildes;				ファイル記述子											*/
/*																								*/
...
/************************************************************************************************/
/******************************** 標準ヘッダ・ファイル ******************************************/
#include "os_IsFileConnect_ins.h"
/****************************************************************************/
/* 機能:ファイルコネクトチェック                                            */
/* 作成日:2002年9月24日                                                     */
/* 変更日:                                                                  */
...
//                                      D_PROC_ISFILECONNECT ) );

    if( ptTEflcTableInd[ fildes - 1 ].acFileName[ 0 ] == '\0' )
                                        // ファイル記述子が示す「ファイル管理
                                        // テーブル個別部のファイル名」が「\0」
                                        // の時
    {
        DbgMsg01( DLv05, ( OutPut, "***** %s:Err Function:%x\n",
                                      D_PROC_ISFILECONNECT, OSFEFILDES ) );
        return( OSFEFILDES ); 
    }
