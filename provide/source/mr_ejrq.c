...
/*********************************************************************/
/*	03-26-2003 mr_cgbf第一引数 (1) を設定	START					 */
/*********************************************************************/	

	rcode = mr_cgbf( 1,			/* ﾒｯｾ-ｼﾞ ｿｳｼﾝﾖｳ ﾊﾞｯﾌｧ ﾉ ｶｸﾄｸ  (L02) (TD59) */
					 blen,									/* (L02) */
					 &buff );
...
/*********************************************************************/
/*	03-26-2003 mr_cgbf第一引数 1 を設定	END							 */
/*********************************************************************/	
	...
	muinf.mrmumk_s.mrmumk4  = 0x0000 ;									/* PRC-005-09 */
