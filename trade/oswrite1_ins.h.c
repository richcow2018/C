...
/************************************************************************************************/
/* 改造番号 ：TBCS0123                                                      					*/
/* 改造内容 ：変換元JISコードの0xbcが重複しているので削除、	                  					*/
/*			  特定コンソール、ログファイル変換後EUCコードに0x5aを追加							*/
/* 改造日   ：2003.06.03                                                    					*/
/* 改造者   ：Supply    朱	                                                					*/
/************************************************************************************************/
#include <sys/msg.h>
...
//システム初期化処理	os_InitSystem
//システム終了処理		os_XXXXX (未決定)
// ***** 定義情報 ***************************************************************
// define名は勝手に命名してあります
...
short sProAfter[] = {					  		// 特定プロセス変換後EUCコード
...
short sConAfter[] = {					  		// 特定コンソール、ログファイル変換後EUCコード
0x41,0x42,0x43,0x44,0x45,0x46,0x47,0x48,			// TBCS0123
0x49,0x4a,0x4b,0x4c,0x4d,0x4e,0x4f,0x50,
0x51,0x52,0x53,0x54,0x55,0x56,0x57,0x58,
