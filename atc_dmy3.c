...
//	size = sizeof( TSRTPSZ ) ;
	...
	for(count = 0; count < 10; count++)
	{
		...
		offset[count] = ( (char *)pscparea.psccmadt - pcData[count]) & 0x00000fff;
				
		PRINTF("mr_jedt2 (4) offset = %08x\n" , offset[count]);

//		offset[count] =  ( pcData[count]  - 0x40017000 ) + 0x0000000c;
